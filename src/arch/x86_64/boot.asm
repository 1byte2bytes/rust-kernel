...
.map_p2_table:
    ; map exc-th P2 entry to a huge page that is at address 2MiB*ecx
...
enable_paging:
    ; load P4 to cr3 register (used by the CPU to access the P4 table)
    mov eax, p4_table
    mov cr3, eax
    ...
    ; enable the paging in the cr0 register
    mov eax, cr0
    or eax, 1 << 31
    mov cr0, eax
